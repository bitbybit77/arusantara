...
export default function PermintaanPenawaranPage() {
    return (
        <PublicSiteShell>
            <Head title="Permintaan Penawaran" />
            <main>
                <GradientHero
                    eyebrow="Permintaan Penawaran · RFQ"
                    title="Permintaan penawaran yang membawa konteks engineering sampai ke panel maker."
                    body="Arusantara menggunakan Request for Quotation (RFQ) sebagai jembatan dari preliminary engineering menuju quotation, technical deviation, revision, hingga Deal."
                >
                ...
                <section id="lifecycle" className="mx-auto max-w-[1500px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
                    <div className="max-w-4xl">
                        <p className="text-sm font-medium text-[#5F6B65]">Procurement lifecycle</p>
                        <h2 className="mt-4 text-4xl font-bold tracking-[-0.055em] text-[#18201D] sm:text-5xl">
                    ...
                    <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                        {lifecycle.map(([no, title, body, Icon]) => (
                            <div key={no} className="rounded-2xl border border-[#153F32]/10 bg-white p-7 transition hover:-translate-y-0.5 hover:shadow-[0_18px_45px_rgba(24,32,29,0.07)]">
                                <div className="flex items-center justify-between">
                                    <span className="grid h-11 w-11 place-items-center rounded-xl bg-[#153F32]/7 text-[#153F32]"><Icon className="h-5 w-5" /></span>
                                    <span className="font-mono text-[10px] font-bold tracking-[0.15em] text-[#8A7562]">{no}</span>
                                </div>
                ...
                <section className="bg-[#0D1512] text-white">
                    <div className="mx-auto grid max-w-[1500px] gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-12 lg:py-28">
                        <div>
                            <p className="text-sm font-medium text-white/60">Technical deviation</p>
                        ...
                        <div className="overflow-hidden rounded-2xl border border-white/12 bg-white/7">
                            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 px-6 py-5">
                                <div>
                                    <p className="text-[11px] font-medium text-white/48">Technical Deviation</p>
                                    <h3 className="mt-1 text-lg font-bold">TD-01</h3>
                                </div>
                                <span className="rounded-full bg-[#E7B083]/12 px-3 py-1.5 text-[10px] font-bold text-[#F2D6BD]">Discuss</span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2 border-t border-white/10 p-6">
                                <button type="button" className="rounded-xl bg-white px-4 py-2.5 text-xs font-bold text-[#153F32]">Accept</button>
                                <button type="button" className="rounded-xl border border-white/16 bg-white/7 px-4 py-2.5 text-xs font-bold text-white">Discuss</button>
                                <button type="button" className="rounded-xl border border-white/16 bg-transparent px-4 py-2.5 text-xs font-bold text-white/70">Reject</button>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="mx-auto max-w-[1500px] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
                    <div className="grid gap-6 lg:grid-cols-[1.15fr_.85fr]">
                        <div className="rounded-2xl bg-[linear-gradient(135deg,#E8E0D2,#F3DFCB)] p-8 lg:p-10">
                            ...
                            <p className="mt-8 text-sm font-medium text-[#5F6B65]">Quotation revision</p>
                            <h3 className="mt-3 max-w-2xl text-4xl font-bold tracking-[-0.055em] text-[#18201D]">Quote V1 tidak hilang ketika V2 dibuat.</h3>
                        ...
                        <div className="rounded-2xl border border-[#153F32]/10 bg-white p-8 lg:p-10">
                            ...
                            <p className="mt-8 text-sm font-medium text-[#5F6B65]">Accepted terms</p>
                            <h3 className="mt-3 text-3xl font-bold tracking-[-0.05em] text-[#18201D]">Deal membekukan hasil yang disepakati.</h3>
                    ...
                    <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-[#153F32]/10 pt-8">
                        <div>
                            <p className="text-sm font-bold text-[#18201D]">Panel maker menerima konteks yang sama.</p>
                            <p className="mt-1 text-sm text-[#68736E]">Lihat bagaimana maker menangani RFQ dan quotation.</p>
                        </div>
                        <Link href="/panel-makers" className="inline-flex items-center gap-2 rounded-xl bg-[#153F32] px-5 py-3 text-sm font-bold text-white">
...
function Meta({ label, value }: { label: string; value: string }) {
    return (
        <div className="rounded-xl border border-white/10 bg-white/5 p-4">
            <p className="text-[9px] font-bold uppercase tracking-[0.12em] text-white/32">{label}</p>
